...
class OmkarNarsale:
    def __init__(self):
        ...
        self.interests = ["Data Science", "Power BI", "AI/ML", "Web Dev", "DSA"]
        self.current_focus = "Building data analytics dashboards and AI-powered tools"
        self.philosophy = "Consistency over hype — building my profile one step at a time."
...
#### 🤖 Zen-Task AI — Smart To-Do App

**AI-Integrated Productivity Tool**

![HTML](https://img.shields.io/badge/-HTML-E34F26?style=flat&logo=html5&logoColor=white)
![JavaScript](https://img.shields.io/badge/-JavaScript-F7DF1E?style=flat&logo=javascript&logoColor=black)
![AI](https://img.shields.io/badge/-AI%20Integrated-8E44AD?style=flat&logo=openai&logoColor=white)

Advanced task management with AI smarts:

- 🤖 **AI-powered** task suggestions and prioritization
- 🎯 **Smart productivity** features for focus and consistency
- 📱 **Fully responsive** — desktop and mobile ready
- 🌓 **Clean UI** — minimal, distraction-free interface
- 🚀 **Shipped & live** — production-ready
...
![NLP](https://img.shields.io/badge/-NLP-FF6F61?style=flat&logo=openai&logoColor=white)
...
<p align="center">💭 <em>"Building data products that speak for themselves"</em></p>

<p align="center">⭐ Star my repos if you find them useful!</p>

<p align="center">Made with ❤️ and lots of ☕<br/>B.Tech IT @ SAKEC • Building real stuff since 2024</p>
